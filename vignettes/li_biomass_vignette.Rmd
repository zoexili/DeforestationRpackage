...
```{r}
loss <- raster(file.path("C:/Users/Li/Desktop/geog_346/deforestation/inst/extdata/forest_loss.tif"))
...
```{r}
# read raster
undisturbed <- raster(file.path("C:/Users/Li/Desktop/geog_346/deforestation/inst/extdata/forest_nondisturbances.tif"))
