...
writeRaster(biomass_clip, filename = file.path("inst/extdata/", "biomass_FIA_ALD_2000.tif"))
biomass_FIA_ALD2000 <- raster(file.path("inst/extdata/", "biomass_FIA_ALD_2000.tif"))
plot_noaxes(biomass_FIA_ALD2000, main = "Aboveground Live Dry Biomass 2000", legend.args = list(text = expression("kg C m"^-2, "                       y"^-1)))
# 0-335: low, medium, high. 
