...
studyarea_nad83
st_write(obj = studyarea_nad83, dsn = file.path("inst/extdata/", "studyarea_nad83.shp"))
...
## plot 
par(mar = c(0, 0, 1, 0))
plot(st_geometry(studyarea_nad83[6]), col = rainbow(n = nrow(studyarea_nad83)), main = "Study Area")
...
3.2 Table & bar graph: List total quantities of AGB (g C m-2) of total forest area in 1990 and 2000, over six counties. 
```{r}
# 1990
...
#png("external/figures/bar_agb1990.png", bg = "transparent", height = 5, width = 8, res = 300, units = "in")
ggplot(data = zonal_agb1990_df, aes(x = Name, y = `AGB of total forest land (Kg C m-2)`, fill = Name)) +
...
zonal_agb2000 <- zonal(x = agb2000_kgC, z = studyarea_nad83_ras_rs, fun = "sum") 
plot(zonal_agb2000)
...
#png("external/figures/bar_agb2000.png", bg = "transparent", height = 5, width = 8, res = 300, units = "in")
ggplot(data = zonal_agb2000_df, aes(x = Name, y = `AGB of total forest land (Kg C m-2)`, fill = Name)) +
  geom_bar(colour = "black", stat="identity")+
  theme_classic()
#dev.off()

# Join two dfs and create one bar graph
df <- full_join(x = zonal_agb1990_df, y = zonal_agb2000_df)
df$year <- c("1990","1990" , "1990", "1990", "1990", "1990", "2000", "2000", "2000", "2000", "2000", "2000")  # year column needs to be character, not numeric.
