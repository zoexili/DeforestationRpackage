...
# rastervis
png("external/figures/agb2000_rastervis.png", bg = "black", height = 5, width = 5, res = 300, units = "in")
...
df$year <- c("1990","1990" , "1990", "1990", "1990", "1990", "2000", "2000", "2000", "2000", "2000", "2000","2000 NBCD", "2000 NBCD", "2000 NBCD", "2000 NBCD", "2000 NBCD", "2000 NBCD")  # year column needs to be character, not numeric.
...
ggplot(data = df, aes(x = Name, y = `AGB of total forest land (Kg C m-2)`, fill = year)) +
  ...
  ggtitle("Aboveground Woody Biomass of Total Forest Land")+
...
ggplot(data = zonal_loss1990_df, aes(x = Name, y = `AGB of harvested forest land (Kg C m-2)`, fill = Name)) +
  ...
  ggtitle("Aboveground Woody Biomass of Forest Harvested Land")+
  theme(plot.background = element_rect(fill = "lightgrey"))
dev.off()
```
...
ggplot(data = zonal_undisturb1990_df, aes(x = Name, y = `AGB of undisturbed forest land (Kg C m-2)`, fill = Name)) +
  geom_bar(colour = "black", stat="identity", show.legend = FALSE)+
  scale_fill_brewer(palette="Set2")+
  ggtitle("Aboveground Woody Biomass of Forest Undisturbed Land")+
  theme(plot.background = element_rect(fill = "lightgrey"))
dev.off()
```
